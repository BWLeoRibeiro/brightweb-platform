...
This repo is prepared for public npm publishing of the `@brightweb/*` packages.
...
`transpilePackages` entries for the `@brightweb/*` packages they install.

Before the first publish, you still need to:

1. Create or claim the `@brightweb` npm scope.
