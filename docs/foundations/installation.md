...
Generated apps also include local AI-agent handoff files in `AGENTS.md`, `docs/ai/README.md`, `docs/ai/examples.md`, and `docs/ai/app-context.json` so coding agents can orient themselves inside the scaffold without relying on repo-internal docs.
