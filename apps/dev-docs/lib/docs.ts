...
const docOrderByHref: Record<string, number> = {
  ...
  "/docs/foundations/validate-your-starter": 70,
  "/docs/modules": 80,
  "/docs/modules/base-contract": 85,
  "/docs/modules/platform-base": 90,
  "/docs/modules/crm": 100,
  "/docs/modules/projects": 110,
  "/docs/modules/using-modules": 120,
  "/docs/recipes": 130,
  "/docs/recipes/platform-first-run": 140,
  "/docs/recipes/site-first-customization": 150,
  "/docs/recipes/add-modules-after-scaffold": 160,
  "/docs/recipes/replace-starter-surfaces": 170,
};
