...
test("published platform scaffolds resolved supabase migrations for the selected modules", async (t) => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "0007_core__20260906111323_restrict_profile_identity_sync.sql",
      "0008_admin__20260316091000_admin_v1.sql",
      "0009_admin__20260724121000_admin_user_invitations.sql",
      "0010_admin__20260729120000_bootstrap_first_admin.sql",
      "0011_admin__20260729150000_bootstrap_first_admin_remove_force.sql",
      "0012_admin__20260731122500_admin_activity_visibility.sql",
      "0013_admin__20260814100000_admin_client_invitations.sql",
      "0014_admin__20260906101616_atomic_admin_invitation_acceptance.sql",
      "0015_orgs__20260316091500_orgs_v1.sql",
      "0016_orgs__20260731130100_organization_search_indexes.sql",
      "0017_orgs__20260812120000_staff_only_organization_access_management.sql",
      "0018_orgs__20260906101616_atomic_organization_invitation_acceptance.sql",
      "0019_orgs__20260906113855_atomic_organization_member_assignment.sql",
      "0020_crm__20260316092000_crm_v1.sql",
      "0021_crm__20260316092010_crm_org_integration.sql",
      "0022_crm__20260421201523_portal_read_indexes.sql",
      "0023_crm__20260724120000_crm_status_authorization.sql",
      "0024_crm__20260731130200_crm_collection_indexes.sql",
      "0025_crm__20260816120000_crm_contact_organizations.sql",
      "0026_crm__20260906101616_atomic_invitation_contact_link.sql",
    ],
  );
  ...
  assert.match(realtimeMigration, /current_notification_items/);
  ...
  const adminActivityMigration = await fs.readFile(
    path.join(targetDir, "supabase", "modules", "admin", "migrations", "20260731122500_admin_activity_visibility.sql"),
    "utf8",
  );
  assert.match(adminActivityMigration, /p_domain = 'admin'/);
...
test("projects scaffolding resolves organizations without CRM", async (t) => {
  ...
  assert.deepEqual(migrations, [
    ...
    "0018_orgs__20260906101616_atomic_organization_invitation_acceptance.sql",
    "0019_orgs__20260906113855_atomic_organization_member_assignment.sql",
    "0020_projects__20260316093000_projects_v1.sql",
    "0021_projects__20260421201528_portal_read_indexes.sql",
    "0022_projects__20260731121000_project_notification_audiences.sql",
    "0023_projects__20260731123000_project_realtime_visibility.sql",
    "0024_projects__20260731124000_project_task_stats.sql",
    "0025_projects__20260731130300_project_collection_indexes.sql",
    ...
    "0037_projects__20260815120000_project_client_access_member_roles.sql",
    "0038_projects__20260815133000_project_admin_creation_and_task_permissions.sql",
  ]);
...
test("install runner is called only when requested and package.json changed", async (t) => {
  ...
  assert.deepEqual(calls, [{ packageManager: "pnpm", cwd: await fs.realpath(targetDir) }]);
});
