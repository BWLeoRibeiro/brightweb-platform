...
test("published platform scaffolds resolved supabase migrations for the selected modules", async (t) => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "0012_admin__20260814100000_admin_client_invitations.sql",
      "0013_orgs__20260316091500_orgs_v1.sql",
      "0014_orgs__20260731130100_organization_search_indexes.sql",
      "0015_orgs__20260812120000_staff_only_organization_access_management.sql",
      "0016_crm__20260316092000_crm_v1.sql",
      "0017_crm__20260316092010_crm_org_integration.sql",
...
test("projects scaffolding resolves organizations without CRM", async (t) => {
  ...
  assert.deepEqual(migrations, [
    ...
    "0014_orgs__20260731130100_organization_search_indexes.sql",
    "0015_orgs__20260812120000_staff_only_organization_access_management.sql",
    "0016_projects__20260316093000_projects_v1.sql",
    "0017_projects__20260421201528_portal_read_indexes.sql",
    "0018_projects__20260731121000_project_notification_audiences.sql",
    "0019_projects__20260731123000_project_realtime_visibility.sql",
    "0020_projects__20260731124000_project_task_stats.sql",
    "0021_projects__20260731130300_project_collection_indexes.sql",
    "0022_projects__20260801122000_project_member_sync.sql",
    "0023_projects__20260804120000_project_task_start_date.sql",
    "0024_projects__20260804123000_project_start_date.sql",
    "0025_projects__20260810120000_project_client_access.sql",
    "0026_projects__20260811120000_project_client_access_expand.sql",
    "0027_projects__20260811120500_project_member_sync_hardening.sql",
    "0028_projects__20260811121000_project_client_access_enforcement.sql",
    "0029_projects__20260811121500_project_client_organization_memberships.sql",
