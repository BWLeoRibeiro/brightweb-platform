...
test("published platform scaffolds resolved supabase migrations for the selected modules", async (t) => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "0006_admin__20260316091000_admin_v1.sql",
      "0007_admin__20260724121000_admin_user_invitations.sql",
      "0008_admin__20260729120000_bootstrap_first_admin.sql",
      "0009_admin__20260729150000_bootstrap_first_admin_remove_force.sql",
      "0010_admin__20260731122500_admin_activity_visibility.sql",
      "0011_orgs__20260316091500_orgs_v1.sql",
      "0012_orgs__20260731130100_organization_search_indexes.sql",
      "0013_crm__20260316092000_crm_v1.sql",
      "0014_crm__20260316092010_crm_org_integration.sql",
      "0015_crm__20260421201523_portal_read_indexes.sql",
      "0016_crm__20260724120000_crm_status_authorization.sql",
      "0017_crm__20260731130200_crm_collection_indexes.sql",
    ],
  );
...
test("projects scaffolding resolves organizations without CRM", async (t) => {
  ...
  assert.deepEqual(migrations, [
    ...
    "0011_orgs__20260316091500_orgs_v1.sql",
    "0012_orgs__20260731130100_organization_search_indexes.sql",
    "0013_projects__20260316093000_projects_v1.sql",
    "0014_projects__20260421201528_portal_read_indexes.sql",
    "0015_projects__20260731121000_project_notification_audiences.sql",
    "0016_projects__20260731123000_project_realtime_visibility.sql",
    "0017_projects__20260731124000_project_task_stats.sql",
    "0018_projects__20260731130300_project_collection_indexes.sql",
  ]);
