...
export const PROJECT_CLIENT_ACCESS_MODES = ["hidden", "all_org_clients", "selected_clients"] as const;
export const PROJECT_MILESTONE_VISIBILITIES = ["staff", "client"] as const;
...
export type ProjectClientAccessMode = (typeof PROJECT_CLIENT_ACCESS_MODES)[number];
export type ProjectMilestoneVisibility = (typeof PROJECT_MILESTONE_VISIBILITIES)[number];
...
export function isProjectClientAccessMode(value: unknown): value is ProjectClientAccessMode {
  return typeof value === "string" && PROJECT_CLIENT_ACCESS_MODES.some((mode) => mode === value);
}

export function isProjectMilestoneVisibility(value: unknown): value is ProjectMilestoneVisibility {
  return typeof value === "string" && PROJECT_MILESTONE_VISIBILITIES.some((visibility) => visibility === value);
}
