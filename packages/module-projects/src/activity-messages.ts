...
export const ptProjectActivityDictionary: ProjectActivityDictionary = {
  ...
  nouns: { project: "um projeto", task: "uma tarefa", milestone: "uma meta", link: "um link", member: "um membro" },
  verbs: {
    ...
    milestoneCreated: " criou a meta ",
    milestoneMoved: " moveu a meta ",
    milestoneUpdated: " atualizou a meta ",
    milestoneDeleted: " eliminou a meta ",
