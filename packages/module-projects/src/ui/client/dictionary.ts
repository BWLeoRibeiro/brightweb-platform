...
export const clientProjectsDictionary = {
  ...
  list: {
    ...
    delayedMilestones: (count: number) => `· ${count} atrasados`,
  ...
  detail: {
    ...
    milestonesCompleted: "Marcos concluídos",
    delayedMilestones: (count: number) => `${count} atrasados`,
    completedMilestones: (percentage: number) => `${percentage}% completos`,
    nextDelivery: "Próxima entrega",
    milestonesTitle: "Marcos do projeto",
    completedOn: (date: string) => `Concluído ${date}`,
    delayedSuffix: " (atrasado)",
