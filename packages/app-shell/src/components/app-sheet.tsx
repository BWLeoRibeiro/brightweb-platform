    ...
    <SheetHeader className={cn(sheetHeaderClassName, editing && sheetHeaderEditingClassName, className)}>
      ...
      <div className="flex items-center gap-3.5">
        ...
        <div className="min-w-0 flex-1">
          <SheetTitle className="truncate text-heading-4 font-bold leading-[var(--type-leading-120)] tracking-[var(--type-tracking-n020)] text-foreground">{title}</SheetTitle>
          {description ? <SheetDescription className="mt-0.5 text-body leading-normal tracking-normal text-muted-foreground">{description}</SheetDescription> : null}
        </div>
