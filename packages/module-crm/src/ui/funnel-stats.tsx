...
import { Card, KpiBreakdownBar, Skeleton, StatTile, StatValue } from "@brightweblabs/ui";
...
export function CrmFunnelStats({
  ...
  return (
    <Card density="compact" className="bg-card p-4" aria-label={dictionary.stats.title}>
