...
function createEnvFileContent(supabaseRegion) {
  return [
    ...
    "EMAIL_BRAND_COLOR_CANVAS=",
    "EMAIL_BRAND_COLOR_SURFACE=",
    "EMAIL_BRAND_COLOR_HEADER=",
    "EMAIL_BRAND_COLOR_HEADER_TEXT=",
    "EMAIL_BRAND_COLOR_HEADER_MUTED_TEXT=",
    "EMAIL_BRAND_COLOR_ACCENT=",
    "EMAIL_BRAND_COLOR_TEXT=",
    "EMAIL_BRAND_COLOR_MUTED_TEXT=",
    "EMAIL_BRAND_COLOR_BORDER=",
    "EMAIL_BRAND_COLOR_PANEL=",
    "EMAIL_BRAND_COLOR_BUTTON=",
    "EMAIL_BRAND_COLOR_BUTTON_TEXT=",
    "EMAIL_BRAND_COLOR_WARNING=",
...
export function createOptionalModuleRouteFiles(selectedModules) {
  ...
  return {
    ...
    "app/api/organizations/[id]/members/[profileId]/route.ts": orgsEnabled
      ? [
        'export const dynamic = "force-dynamic";',
        'export { handleOrganizationMemberPatchRequest as PATCH, handleOrganizationMemberDeleteRequest as DELETE } from "@brightweblabs/module-orgs";',
        "",
      ].join("\n")
      : [
        'export const dynamic = "force-dynamic";',
