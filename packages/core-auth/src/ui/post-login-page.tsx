  ...
  return (
    <main className="auth-post-login">
      <div className="auth-post-login__content" aria-live="polite">
        ...
        <p className="auth-post-login__copy">{dictionary.postLogin.preparing}</p>
...
function PostLoginFallback() {
  ...
  return <main className="auth-post-login"><div className="auth-post-login__content"><div className="auth-layout__brand-logo">{brand.logo}</div><span className="auth-spinner" aria-hidden="true" /><p className="auth-post-login__copy">{dictionary.postLogin.preparing}</p></div></main>;
}
